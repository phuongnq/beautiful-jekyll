...
Familiar with major network protocols such as TCP/IP, HTTP/HTTPS, and ICMP

Familiar with virtualization technologies such as VMWare, OpenStack

Familiar with Linux, BSD OS

Experience with medium scale network topology design and deployment

Hands-on experience with major network equipment

Basic knowledge of Infrastructure as Code, CI, CD

Hands-on experience with scripting (python, bash, etc.)

Can and willing to work in an all English environment (working language is still Japanese, but all systems, UI, and documents are in English)
